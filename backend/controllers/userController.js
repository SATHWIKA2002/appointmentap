...
//   }
// };
// //API TO VERIFY PAYMENT OD RAZORPAY 
...
//       userData,
//       docData,
//       amount: docData.fees, // Amount to be charged
//       slotTime,
//       slotDate,
//       date: Date.now(),
//     };
...
//     await doctorModel.findByIdAndUpdate(docId, { slots_booked });
//     res.json({ success: true, appointmentId: newAppointment._id }); // Return appointment ID for payment
//   } catch (error) {
//     console.log(error);
//     res.json({ success: false, message: error.message });
//   }
...
//       cancelled: true,
//     });
//     // Releasing doctor slot when that particular appointment is cancelled
//     const { docId, slotDate, slotTime } = appointmentData;
//     const doctorData = await doctorModel.findById(docId);
//     let slots_booked = doctorData.slots_booked;
//     slots_booked[slotDate] = slots_booked[slotDate].filter(
